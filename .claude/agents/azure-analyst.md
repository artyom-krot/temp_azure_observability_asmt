...
| COLL (AKS infra) | AKS Infrastructure Coverage | Container Insights enable status, Prometheus scraping config, control plane diagnostic settings, node/pod resource limits, cluster autoscaler logging — findings filed under COLL |
